...
export default function StudySpaceScreen() {
    ...
    const handleDeleteFolder = async (folder: Folder) => {
        Alert.alert(
            'Delete Folder?',
            `Are you sure you want to delete "${folder.name}"? This will not delete the gems inside. ✨`,
            [
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            >
                ...
                <View style={styles.gemsHeaderRow}>
                    <Text style={styles.sectionTitle}>My Study Gems</Text>
                    <TouchableOpacity
                        style={styles.addGemSmallBtn}
                        onPress={() => router.push('/add-study-gem')}
                    >
                        <Ionicons name="add-circle" size={32} color={ACCENT_PINK} />
                    </TouchableOpacity>
                </View>
                ...
                {isLoading ? (
                    ...
                    <View style={styles.emptyArea}>
                        ...
                        <Text style={styles.emptyText}>No gems here yet. Start your collection!</Text>
                        <TouchableOpacity
                            ...
                            >
                                ...
                                <View style={styles.gemFooter}>
                                    <View style={styles.authorRow}>
                                        ...
                                        />
                                        <Text style={styles.authorName}>{user?.fullName || 'StudyBloom'}</Text>
                                    </View>
