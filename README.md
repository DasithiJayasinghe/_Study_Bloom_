...
1.Created Database Scema(foundation)
2.Created API endpoints
3.Updated Mount routed & file uploads
Note- Successfully finished on 09.04.2026

# Phase 2-Mobile Dependencies
4.Updated package.json by installing exam packages.
Note- Successfully completed on 12.04.2026
